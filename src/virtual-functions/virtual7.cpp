 ...
 * При множественном наследовании порядок (class AIO : public "printer", public "scanner") классов наследников играеть роль
 * в инициализации классов. Сначала инициализируется "printer", потом "scanner"
 *
 */
