 ...
 * в с++ слова "интерфейс" официально нет, но, "weapon" можно считать (если смотреть на другие языки программирования)
 * интерфейсом (класс в котором все абстрактное и не имеет любой реализации)
 */
...
int main() {
  //weapon w;     //Ошибка компиляции - класс абстрактный
